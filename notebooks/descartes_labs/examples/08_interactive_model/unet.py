""" Definition of the buildings model used for the Workflows deploy demo """
...
def build_model(input_shape):
    """ Builds the model using the UNet class """
    model_base = UNet(include_top=True)
    inputs = tf.keras.Input(shape=input_shape)
    model = tf.keras.Model(inputs=inputs, outputs=model_base(inputs))
