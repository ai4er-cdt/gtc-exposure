...
def make_ground_dataset_from_ratio_polygons(
    ratio,
    polygons,
    products,
    bands,
...
#                     break
                ...
                # Get raster image
                arr = ratio.compute(ctx).ndarray.reshape(tilesize,tilesize,3) #scenes.mosaic(bands="red green blue", ctx=ctx, bands_axis=-1)
