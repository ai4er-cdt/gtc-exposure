...
unzip results.zip
rm results.zip
mv results change_detection/ratio_method/results
...
rm coastlines.zip
mv coastlines change_detection/ratio_method/coastlines