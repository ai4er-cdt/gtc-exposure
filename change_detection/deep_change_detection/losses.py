...
### From the GitHub repository for Berman et al., 2017, 'The Lovász-Softmax loss: A tractable surrogate for the optimization of the intersection-over-union measure in neural networks'.  https://github.com/bermanmaxim/LovaszSoftmax
...
def soft_dice_loss(outputs, targets, per_image=False):
    ...
    #dice_target = F.one_hot(dice_target.long())
    
    #print(dice_target.shape, dice_output.shape)
...
class DiceLoss(nn.Module):
    def __init__(self, weight=weights, size_average=True, per_image=False):
        super().__init__()
